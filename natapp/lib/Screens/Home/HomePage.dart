...
class _homePage extends State<HomePage>{
  ...
  //final String addUnitId=Platform.isAndroid?"ca-app-pub-6259106624809298/6116286712":"ca-app-pub-6259106624809298/4312799199";
  BannerAd myBanner = BannerAd(
    adUnitId: Platform.isAndroid?"ca-app-pub-3940256099942544/6300978111":"ca-app-pub-6259106624809298/4312799199",
    size: AdSize.banner,
    request: AdRequest(),
  ...
  Widget build(BuildContext context) {
    return PickupLayout(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,title: Text("Users",),
        actions: <Widget>[
          PopupMenuButton(
