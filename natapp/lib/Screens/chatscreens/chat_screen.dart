...
import 'package:natapp/Screens/chatscreens/widgets/chatImageView.dart';
import 'package:natapp/Screens/chatscreens/widgets/chatUserView.dart';
...
class _ChatScreenState extends State<ChatScreen> {
          ...
          title: Row(
            ...
            children: <Widget>[
              ...
              GestureDetector(
                ...
                onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (_)=>chatUserView(widget.receiver))) ,
              ),
  ...
  //     textFieldController.text=lastWords;
  //   });
  // }
        ...
        : message.photoUrl != null
            ? Hero(
                ...
                child: GestureDetector(
                  onTap: () async {
                    String imageName = getImageName(message.photoUrl);
                    String finalDir = await baseDirectroy();
                    var finalPath = File(finalDir + '/$imageName' + ".jpg");
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) {
                      return chatImageView(finalPath.path, widget.receiver.name,
                          message.photoUrl);
                    }));
                  },
                  child: CachedImage(
